...
def test_lorenz_curve_with_array():
    income = np.array([20000, 25000, 27000, 30000, 35000, 45000, 60000, 75000, 80000, 120000])
...
def test_lorenz_curve_with_dataframe():
    df = pd.DataFrame({'income': [20000, 25000, 27000, 30000, 35000, 45000, 60000, 75000, 80000, 120000]})
